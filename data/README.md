...
| `reference/` | `teams_2025/2026.rds` (FBS membership, names, logos), `team_directory.rds` (logo URLs), `market/betting_lines_2023_2025.rds` (closing-line benchmark), `incumbent_predictions/` (EB_features walk-forward predictions: dev 2019/21/22 and cond 2023-25), `production_snapshots_2026/` (weekly production snapshots committed by CI, wk01-wk03), `cfp_final_rankings_2018_2025.csv` (CFP committee's final selection-day top 25 from the CFBD rankings API; fits the CFP ranking in `scripts/calibrate_cfp_ranking.R`) | Read-mostly. Add `teams_2027.rds` here next season. |
