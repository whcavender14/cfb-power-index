# Adapted from the old folder's scripts/export_betting_data.R: identical logic;
# paths now come from config/paths.R. Needs CFBD_API_KEY for live lines.
...
if (is.null(g)) g <- optional(frozen_path("cfb_data_v3",sprintf("raw_schedule_%d.rds",season)))
